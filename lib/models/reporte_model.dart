...
// Modelo para datos de municipios (GeoJSON)
class MunicipioData {
  final String id;
  final String nombre;
  final String departamento;
  final String departamentoId;
  final List<List<Offset>> poligonos; // Lista de polígonos para dibujar el municipio
  final Offset centro; // Punto central para colocar etiquetas
...
// Modelo para datos de departamentos con GeoJSON
class DepartamentoGeoData {
  final String id;
  final String nombre;
  final List<List<Offset>> poligonos; // Lista de polígonos para dibujar el departamento
  final Offset centro; // Punto central para colocar etiquetas
  final List<MunicipioData> municipios; // Municipios que componen el departamento
  final bool esElementoEspecial; // Indica si es un elemento especial como un lago
